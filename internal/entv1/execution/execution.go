...
const (
	...
	// OutputsInverseTable is the table name for the Output entity.
	// It exists in this package in order to avoid circular dependency with the "output" package.
	OutputsInverseTable = "outputs"
...
func StateValidator(s State) error {
	...
	case StateUnknown, StateStopped, StateRunning, StateFailed, StatePending, StatePaused, StateSkipped:
		return nil
	default:
		return fmt.Errorf("execution: invalid enum value for state field: %q", s)
	}
}
...
func PreviousStateValidator(ps PreviousState) error {
	...
	case PreviousStateUnknown, PreviousStateStopped, PreviousStateRunning, PreviousStateFailed, PreviousStatePending, PreviousStatePaused, PreviousStateSkipped:
		return nil
	default:
		return fmt.Errorf("execution: invalid enum value for previous_state field: %q", ps)
	}
}
