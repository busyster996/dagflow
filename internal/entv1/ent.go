...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			output.Table:     output.ValidColumn,
			param.Table:      param.ValidColumn,
			step.Table:       step.ValidColumn,
			stepdepend.Table: stepdepend.ValidColumn,
			stepparam.Table:  stepparam.ValidColumn,
			task.Table:       task.ValidColumn,
			taskparam.Table:  taskparam.ValidColumn,
		})
	})
