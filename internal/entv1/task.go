...
// was not loaded in eager-loading.
func (e TaskEdges) ExecutionsOrErr() ([]*Execution, error) {
	if e.loadedTypes[2] {
...
// QueryExecutions queries the "executions" edge of the Task entity.
func (_m *Task) QueryExecutions() *ExecutionQuery {
	return NewTaskClient(_m.config).QueryExecutions(_m)
}
