// Code generated by 'yaegi extract go.yaml.in/yaml/v3'. DO NOT EDIT.
...
func init() {
	Symbols["go.yaml.in/yaml/v3/yaml"] = map[string]reflect.Value{
		...
		"_IsZeroer":    reflect.ValueOf((*_go_yaml_in_yaml_v3_IsZeroer)(nil)),
		"_Marshaler":   reflect.ValueOf((*_go_yaml_in_yaml_v3_Marshaler)(nil)),
		"_Unmarshaler": reflect.ValueOf((*_go_yaml_in_yaml_v3_Unmarshaler)(nil)),
	}
}

// _go_yaml_in_yaml_v3_IsZeroer is an interface wrapper for IsZeroer type
type _go_yaml_in_yaml_v3_IsZeroer struct {
	IValue  interface{}
	WIsZero func() bool
}

func (W _go_yaml_in_yaml_v3_IsZeroer) IsZero() bool {
	return W.WIsZero()
}

// _go_yaml_in_yaml_v3_Marshaler is an interface wrapper for Marshaler type
type _go_yaml_in_yaml_v3_Marshaler struct {
	IValue       interface{}
	WMarshalYAML func() (interface{}, error)
}

func (W _go_yaml_in_yaml_v3_Marshaler) MarshalYAML() (interface{}, error) {
	return W.WMarshalYAML()
}

// _go_yaml_in_yaml_v3_Unmarshaler is an interface wrapper for Unmarshaler type
type _go_yaml_in_yaml_v3_Unmarshaler struct {
	IValue         interface{}
	WUnmarshalYAML func(value *yaml.Node) error
}

func (W _go_yaml_in_yaml_v3_Unmarshaler) UnmarshalYAML(value *yaml.Node) error {
