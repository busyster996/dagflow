...
func init() {
	Symbols["github.com/redis/go-redis/v9/redis"] = map[string]reflect.Value{
		...
		"ErrCrossSlot":                   reflect.ValueOf(&redis.ErrCrossSlot).Elem(),
		"ErrPoolExhausted":               reflect.ValueOf(&redis.ErrPoolExhausted).Elem(),
		"ErrPoolTimeout":                 reflect.ValueOf(&redis.ErrPoolTimeout).Elem(),
		...
		"NewFloatSliceResult":            reflect.ValueOf(redis.NewFloatSliceResult),
		...
		"NewVectorInfoSliceCmd":          reflect.ValueOf(redis.NewVectorInfoSliceCmd),
		...
		"ParseFailoverURL":               reflect.ValueOf(redis.ParseFailoverURL),
		...
		"VAddArgs":                   reflect.ValueOf((*redis.VAddArgs)(nil)),
		"VSimArgs":                   reflect.ValueOf((*redis.VSimArgs)(nil)),
		"Vector":                     reflect.ValueOf((*redis.Vector)(nil)),
		"VectorFP32":                 reflect.ValueOf((*redis.VectorFP32)(nil)),
		"VectorRef":                  reflect.ValueOf((*redis.VectorRef)(nil)),
		"VectorScore":                reflect.ValueOf((*redis.VectorScore)(nil)),
		"VectorScoreSliceCmd":        reflect.ValueOf((*redis.VectorScoreSliceCmd)(nil)),
		"VectorSetCmdable":           reflect.ValueOf((*redis.VectorSetCmdable)(nil)),
		"VectorValues":               reflect.ValueOf((*redis.VectorValues)(nil)),
		...
		"_Vector":                    reflect.ValueOf((*_github_com_redis_go_redis_v9_Vector)(nil)),
		"_VectorSetCmdable":          reflect.ValueOf((*_github_com_redis_go_redis_v9_VectorSetCmdable)(nil)),
	}
}
...
type _github_com_redis_go_redis_v9_Cmdable struct {
	...
	WVAdd                         func(ctx context.Context, key string, element string, val redis.Vector) *redis.BoolCmd
	WVAddWithArgs                 func(ctx context.Context, key string, element string, val redis.Vector, addArgs *redis.VAddArgs) *redis.BoolCmd
	WVCard                        func(ctx context.Context, key string) *redis.IntCmd
	WVClearAttributes             func(ctx context.Context, key string, element string) *redis.BoolCmd
	WVDim                         func(ctx context.Context, key string) *redis.IntCmd
	WVEmb                         func(ctx context.Context, key string, element string, raw bool) *redis.SliceCmd
	WVGetAttr                     func(ctx context.Context, key string, element string) *redis.StringCmd
	WVInfo                        func(ctx context.Context, key string) *redis.MapStringInterfaceCmd
	WVLinks                       func(ctx context.Context, key string, element string) *redis.StringSliceCmd
	WVLinksWithScores             func(ctx context.Context, key string, element string) *redis.VectorScoreSliceCmd
	WVRandMember                  func(ctx context.Context, key string) *redis.StringCmd
	WVRandMemberCount             func(ctx context.Context, key string, count int) *redis.StringSliceCmd
	WVRem                         func(ctx context.Context, key string, element string) *redis.BoolCmd
	WVSetAttr                     func(ctx context.Context, key string, element string, attr interface{}) *redis.BoolCmd
	WVSim                         func(ctx context.Context, key string, val redis.Vector) *redis.StringSliceCmd
	WVSimWithArgs                 func(ctx context.Context, key string, val redis.Vector, args *redis.VSimArgs) *redis.StringSliceCmd
...
func (W _github_com_redis_go_redis_v9_Cmdable) VAdd(ctx context.Context, key string, element string, val redis.Vector) *redis.BoolCmd {
	return W.WVAdd(ctx, key, element, val)
}
func (W _github_com_redis_go_redis_v9_Cmdable) VAddWithArgs(ctx context.Context, key string, element string, val redis.Vector, addArgs *redis.VAddArgs) *redis.BoolCmd {
	return W.WVAddWithArgs(ctx, key, element, val, addArgs)
}
func (W _github_com_redis_go_redis_v9_Cmdable) VCard(ctx context.Context, key string) *redis.IntCmd {
	return W.WVCard(ctx, key)
}
func (W _github_com_redis_go_redis_v9_Cmdable) VClearAttributes(ctx context.Context, key string, element string) *redis.BoolCmd {
	return W.WVClearAttributes(ctx, key, element)
}
func (W _github_com_redis_go_redis_v9_Cmdable) VDim(ctx context.Context, key string) *redis.IntCmd {
	return W.WVDim(ctx, key)
}
func (W _github_com_redis_go_redis_v9_Cmdable) VEmb(ctx context.Context, key string, element string, raw bool) *redis.SliceCmd {
	return W.WVEmb(ctx, key, element, raw)
}
func (W _github_com_redis_go_redis_v9_Cmdable) VGetAttr(ctx context.Context, key string, element string) *redis.StringCmd {
	return W.WVGetAttr(ctx, key, element)
}
func (W _github_com_redis_go_redis_v9_Cmdable) VInfo(ctx context.Context, key string) *redis.MapStringInterfaceCmd {
	return W.WVInfo(ctx, key)
}
func (W _github_com_redis_go_redis_v9_Cmdable) VLinks(ctx context.Context, key string, element string) *redis.StringSliceCmd {
	return W.WVLinks(ctx, key, element)
}
func (W _github_com_redis_go_redis_v9_Cmdable) VLinksWithScores(ctx context.Context, key string, element string) *redis.VectorScoreSliceCmd {
	return W.WVLinksWithScores(ctx, key, element)
}
func (W _github_com_redis_go_redis_v9_Cmdable) VRandMember(ctx context.Context, key string) *redis.StringCmd {
	return W.WVRandMember(ctx, key)
}
func (W _github_com_redis_go_redis_v9_Cmdable) VRandMemberCount(ctx context.Context, key string, count int) *redis.StringSliceCmd {
	return W.WVRandMemberCount(ctx, key, count)
}
func (W _github_com_redis_go_redis_v9_Cmdable) VRem(ctx context.Context, key string, element string) *redis.BoolCmd {
	return W.WVRem(ctx, key, element)
}
func (W _github_com_redis_go_redis_v9_Cmdable) VSetAttr(ctx context.Context, key string, element string, attr interface{}) *redis.BoolCmd {
	return W.WVSetAttr(ctx, key, element, attr)
}
func (W _github_com_redis_go_redis_v9_Cmdable) VSim(ctx context.Context, key string, val redis.Vector) *redis.StringSliceCmd {
	return W.WVSim(ctx, key, val)
}
func (W _github_com_redis_go_redis_v9_Cmdable) VSimWithArgs(ctx context.Context, key string, val redis.Vector, args *redis.VSimArgs) *redis.StringSliceCmd {
	return W.WVSimWithArgs(ctx, key, val, args)
}
func (W _github_com_redis_go_redis_v9_Cmdable) VSimWithArgsWithScores(ctx context.Context, key string, val redis.Vector, args *redis.VSimArgs) *redis.VectorScoreSliceCmd {
	return W.WVSimWithArgsWithScores(ctx, key, val, args)
}
func (W _github_com_redis_go_redis_v9_Cmdable) VSimWithScores(ctx context.Context, key string, val redis.Vector) *redis.VectorScoreSliceCmd {
	return W.WVSimWithScores(ctx, key, val)
}
...
func (W _github_com_redis_go_redis_v9_Pipeliner) VAdd(ctx context.Context, key string, element string, val redis.Vector) *redis.BoolCmd {
	return W.WVAdd(ctx, key, element, val)
}
func (W _github_com_redis_go_redis_v9_Pipeliner) VAddWithArgs(ctx context.Context, key string, element string, val redis.Vector, addArgs *redis.VAddArgs) *redis.BoolCmd {
	return W.WVAddWithArgs(ctx, key, element, val, addArgs)
}
func (W _github_com_redis_go_redis_v9_Pipeliner) VCard(ctx context.Context, key string) *redis.IntCmd {
	return W.WVCard(ctx, key)
}
func (W _github_com_redis_go_redis_v9_Pipeliner) VClearAttributes(ctx context.Context, key string, element string) *redis.BoolCmd {
	return W.WVClearAttributes(ctx, key, element)
}
func (W _github_com_redis_go_redis_v9_Pipeliner) VDim(ctx context.Context, key string) *redis.IntCmd {
	return W.WVDim(ctx, key)
}
func (W _github_com_redis_go_redis_v9_Pipeliner) VEmb(ctx context.Context, key string, element string, raw bool) *redis.SliceCmd {
	return W.WVEmb(ctx, key, element, raw)
}
func (W _github_com_redis_go_redis_v9_Pipeliner) VGetAttr(ctx context.Context, key string, element string) *redis.StringCmd {
	return W.WVGetAttr(ctx, key, element)
}
func (W _github_com_redis_go_redis_v9_Pipeliner) VInfo(ctx context.Context, key string) *redis.MapStringInterfaceCmd {
	return W.WVInfo(ctx, key)
}
func (W _github_com_redis_go_redis_v9_Pipeliner) VLinks(ctx context.Context, key string, element string) *redis.StringSliceCmd {
	return W.WVLinks(ctx, key, element)
}
func (W _github_com_redis_go_redis_v9_Pipeliner) VLinksWithScores(ctx context.Context, key string, element string) *redis.VectorScoreSliceCmd {
	return W.WVLinksWithScores(ctx, key, element)
}
func (W _github_com_redis_go_redis_v9_Pipeliner) VRandMember(ctx context.Context, key string) *redis.StringCmd {
	return W.WVRandMember(ctx, key)
}
func (W _github_com_redis_go_redis_v9_Pipeliner) VRandMemberCount(ctx context.Context, key string, count int) *redis.StringSliceCmd {
	return W.WVRandMemberCount(ctx, key, count)
}
func (W _github_com_redis_go_redis_v9_Pipeliner) VRem(ctx context.Context, key string, element string) *redis.BoolCmd {
	return W.WVRem(ctx, key, element)
}
func (W _github_com_redis_go_redis_v9_Pipeliner) VSetAttr(ctx context.Context, key string, element string, attr interface{}) *redis.BoolCmd {
	return W.WVSetAttr(ctx, key, element, attr)
}
func (W _github_com_redis_go_redis_v9_Pipeliner) VSim(ctx context.Context, key string, val redis.Vector) *redis.StringSliceCmd {
	return W.WVSim(ctx, key, val)
}
func (W _github_com_redis_go_redis_v9_Pipeliner) VSimWithArgs(ctx context.Context, key string, val redis.Vector, args *redis.VSimArgs) *redis.StringSliceCmd {
	return W.WVSimWithArgs(ctx, key, val, args)
}
func (W _github_com_redis_go_redis_v9_Pipeliner) VSimWithArgsWithScores(ctx context.Context, key string, val redis.Vector, args *redis.VSimArgs) *redis.VectorScoreSliceCmd {
	return W.WVSimWithArgsWithScores(ctx, key, val, args)
}
func (W _github_com_redis_go_redis_v9_Pipeliner) VSimWithScores(ctx context.Context, key string, val redis.Vector) *redis.VectorScoreSliceCmd {
	return W.WVSimWithScores(ctx, key, val)
}
...
func (W _github_com_redis_go_redis_v9_StatefulCmdable) VAdd(ctx context.Context, key string, element string, val redis.Vector) *redis.BoolCmd {
	return W.WVAdd(ctx, key, element, val)
}
func (W _github_com_redis_go_redis_v9_StatefulCmdable) VAddWithArgs(ctx context.Context, key string, element string, val redis.Vector, addArgs *redis.VAddArgs) *redis.BoolCmd {
	return W.WVAddWithArgs(ctx, key, element, val, addArgs)
}
func (W _github_com_redis_go_redis_v9_StatefulCmdable) VCard(ctx context.Context, key string) *redis.IntCmd {
	return W.WVCard(ctx, key)
}
func (W _github_com_redis_go_redis_v9_StatefulCmdable) VClearAttributes(ctx context.Context, key string, element string) *redis.BoolCmd {
	return W.WVClearAttributes(ctx, key, element)
}
func (W _github_com_redis_go_redis_v9_StatefulCmdable) VDim(ctx context.Context, key string) *redis.IntCmd {
	return W.WVDim(ctx, key)
}
func (W _github_com_redis_go_redis_v9_StatefulCmdable) VEmb(ctx context.Context, key string, element string, raw bool) *redis.SliceCmd {
	return W.WVEmb(ctx, key, element, raw)
}
func (W _github_com_redis_go_redis_v9_StatefulCmdable) VGetAttr(ctx context.Context, key string, element string) *redis.StringCmd {
	return W.WVGetAttr(ctx, key, element)
}
func (W _github_com_redis_go_redis_v9_StatefulCmdable) VInfo(ctx context.Context, key string) *redis.MapStringInterfaceCmd {
	return W.WVInfo(ctx, key)
}
func (W _github_com_redis_go_redis_v9_StatefulCmdable) VLinks(ctx context.Context, key string, element string) *redis.StringSliceCmd {
	return W.WVLinks(ctx, key, element)
}
func (W _github_com_redis_go_redis_v9_StatefulCmdable) VLinksWithScores(ctx context.Context, key string, element string) *redis.VectorScoreSliceCmd {
	return W.WVLinksWithScores(ctx, key, element)
}
func (W _github_com_redis_go_redis_v9_StatefulCmdable) VRandMember(ctx context.Context, key string) *redis.StringCmd {
	return W.WVRandMember(ctx, key)
}
func (W _github_com_redis_go_redis_v9_StatefulCmdable) VRandMemberCount(ctx context.Context, key string, count int) *redis.StringSliceCmd {
	return W.WVRandMemberCount(ctx, key, count)
}
func (W _github_com_redis_go_redis_v9_StatefulCmdable) VRem(ctx context.Context, key string, element string) *redis.BoolCmd {
	return W.WVRem(ctx, key, element)
}
func (W _github_com_redis_go_redis_v9_StatefulCmdable) VSetAttr(ctx context.Context, key string, element string, attr interface{}) *redis.BoolCmd {
	return W.WVSetAttr(ctx, key, element, attr)
}
func (W _github_com_redis_go_redis_v9_StatefulCmdable) VSim(ctx context.Context, key string, val redis.Vector) *redis.StringSliceCmd {
	return W.WVSim(ctx, key, val)
}
func (W _github_com_redis_go_redis_v9_StatefulCmdable) VSimWithArgs(ctx context.Context, key string, val redis.Vector, args *redis.VSimArgs) *redis.StringSliceCmd {
	return W.WVSimWithArgs(ctx, key, val, args)
}
func (W _github_com_redis_go_redis_v9_StatefulCmdable) VSimWithArgsWithScores(ctx context.Context, key string, val redis.Vector, args *redis.VSimArgs) *redis.VectorScoreSliceCmd {
	return W.WVSimWithArgsWithScores(ctx, key, val, args)
}
func (W _github_com_redis_go_redis_v9_StatefulCmdable) VSimWithScores(ctx context.Context, key string, val redis.Vector) *redis.VectorScoreSliceCmd {
	return W.WVSimWithScores(ctx, key, val)
}
...
func (W _github_com_redis_go_redis_v9_UniversalClient) VAdd(ctx context.Context, key string, element string, val redis.Vector) *redis.BoolCmd {
	return W.WVAdd(ctx, key, element, val)
}
func (W _github_com_redis_go_redis_v9_UniversalClient) VAddWithArgs(ctx context.Context, key string, element string, val redis.Vector, addArgs *redis.VAddArgs) *redis.BoolCmd {
	return W.WVAddWithArgs(ctx, key, element, val, addArgs)
}
func (W _github_com_redis_go_redis_v9_UniversalClient) VCard(ctx context.Context, key string) *redis.IntCmd {
	return W.WVCard(ctx, key)
}
func (W _github_com_redis_go_redis_v9_UniversalClient) VClearAttributes(ctx context.Context, key string, element string) *redis.BoolCmd {
	return W.WVClearAttributes(ctx, key, element)
}
func (W _github_com_redis_go_redis_v9_UniversalClient) VDim(ctx context.Context, key string) *redis.IntCmd {
	return W.WVDim(ctx, key)
}
func (W _github_com_redis_go_redis_v9_UniversalClient) VEmb(ctx context.Context, key string, element string, raw bool) *redis.SliceCmd {
	return W.WVEmb(ctx, key, element, raw)
}
func (W _github_com_redis_go_redis_v9_UniversalClient) VGetAttr(ctx context.Context, key string, element string) *redis.StringCmd {
	return W.WVGetAttr(ctx, key, element)
}
func (W _github_com_redis_go_redis_v9_UniversalClient) VInfo(ctx context.Context, key string) *redis.MapStringInterfaceCmd {
	return W.WVInfo(ctx, key)
}
func (W _github_com_redis_go_redis_v9_UniversalClient) VLinks(ctx context.Context, key string, element string) *redis.StringSliceCmd {
	return W.WVLinks(ctx, key, element)
}
func (W _github_com_redis_go_redis_v9_UniversalClient) VLinksWithScores(ctx context.Context, key string, element string) *redis.VectorScoreSliceCmd {
	return W.WVLinksWithScores(ctx, key, element)
}
func (W _github_com_redis_go_redis_v9_UniversalClient) VRandMember(ctx context.Context, key string) *redis.StringCmd {
	return W.WVRandMember(ctx, key)
}
func (W _github_com_redis_go_redis_v9_UniversalClient) VRandMemberCount(ctx context.Context, key string, count int) *redis.StringSliceCmd {
	return W.WVRandMemberCount(ctx, key, count)
}
func (W _github_com_redis_go_redis_v9_UniversalClient) VRem(ctx context.Context, key string, element string) *redis.BoolCmd {
	return W.WVRem(ctx, key, element)
}
func (W _github_com_redis_go_redis_v9_UniversalClient) VSetAttr(ctx context.Context, key string, element string, attr interface{}) *redis.BoolCmd {
	return W.WVSetAttr(ctx, key, element, attr)
}
func (W _github_com_redis_go_redis_v9_UniversalClient) VSim(ctx context.Context, key string, val redis.Vector) *redis.StringSliceCmd {
	return W.WVSim(ctx, key, val)
}
func (W _github_com_redis_go_redis_v9_UniversalClient) VSimWithArgs(ctx context.Context, key string, val redis.Vector, args *redis.VSimArgs) *redis.StringSliceCmd {
	return W.WVSimWithArgs(ctx, key, val, args)
}
func (W _github_com_redis_go_redis_v9_UniversalClient) VSimWithArgsWithScores(ctx context.Context, key string, val redis.Vector, args *redis.VSimArgs) *redis.VectorScoreSliceCmd {
	return W.WVSimWithArgsWithScores(ctx, key, val, args)
}
func (W _github_com_redis_go_redis_v9_UniversalClient) VSimWithScores(ctx context.Context, key string, val redis.Vector) *redis.VectorScoreSliceCmd {
	return W.WVSimWithScores(ctx, key, val)
}
...
// _github_com_redis_go_redis_v9_Vector is an interface wrapper for Vector type
type _github_com_redis_go_redis_v9_Vector struct {
	IValue interface{}
	WValue func() []any
}

func (W _github_com_redis_go_redis_v9_Vector) Value() []any {
	return W.WValue()
}

// _github_com_redis_go_redis_v9_VectorSetCmdable is an interface wrapper for VectorSetCmdable type
type _github_com_redis_go_redis_v9_VectorSetCmdable struct {
	IValue                  interface{}
	WVAdd                   func(ctx context.Context, key string, element string, val redis.Vector) *redis.BoolCmd
	WVAddWithArgs           func(ctx context.Context, key string, element string, val redis.Vector, addArgs *redis.VAddArgs) *redis.BoolCmd
	WVCard                  func(ctx context.Context, key string) *redis.IntCmd
...
func (W _github_com_redis_go_redis_v9_VectorSetCmdable) VAdd(ctx context.Context, key string, element string, val redis.Vector) *redis.BoolCmd {
	return W.WVAdd(ctx, key, element, val)
}
func (W _github_com_redis_go_redis_v9_VectorSetCmdable) VAddWithArgs(ctx context.Context, key string, element string, val redis.Vector, addArgs *redis.VAddArgs) *redis.BoolCmd {
	return W.WVAddWithArgs(ctx, key, element, val, addArgs)
}
func (W _github_com_redis_go_redis_v9_VectorSetCmdable) VCard(ctx context.Context, key string) *redis.IntCmd {
	return W.WVCard(ctx, key)
}
func (W _github_com_redis_go_redis_v9_VectorSetCmdable) VClearAttributes(ctx context.Context, key string, element string) *redis.BoolCmd {
	return W.WVClearAttributes(ctx, key, element)
}
func (W _github_com_redis_go_redis_v9_VectorSetCmdable) VDim(ctx context.Context, key string) *redis.IntCmd {
	return W.WVDim(ctx, key)
}
func (W _github_com_redis_go_redis_v9_VectorSetCmdable) VEmb(ctx context.Context, key string, element string, raw bool) *redis.SliceCmd {
	return W.WVEmb(ctx, key, element, raw)
}
func (W _github_com_redis_go_redis_v9_VectorSetCmdable) VGetAttr(ctx context.Context, key string, element string) *redis.StringCmd {
	return W.WVGetAttr(ctx, key, element)
}
func (W _github_com_redis_go_redis_v9_VectorSetCmdable) VInfo(ctx context.Context, key string) *redis.MapStringInterfaceCmd {
	return W.WVInfo(ctx, key)
}
func (W _github_com_redis_go_redis_v9_VectorSetCmdable) VLinks(ctx context.Context, key string, element string) *redis.StringSliceCmd {
	return W.WVLinks(ctx, key, element)
}
func (W _github_com_redis_go_redis_v9_VectorSetCmdable) VLinksWithScores(ctx context.Context, key string, element string) *redis.VectorScoreSliceCmd {
	return W.WVLinksWithScores(ctx, key, element)
}
func (W _github_com_redis_go_redis_v9_VectorSetCmdable) VRandMember(ctx context.Context, key string) *redis.StringCmd {
	return W.WVRandMember(ctx, key)
}
func (W _github_com_redis_go_redis_v9_VectorSetCmdable) VRandMemberCount(ctx context.Context, key string, count int) *redis.StringSliceCmd {
	return W.WVRandMemberCount(ctx, key, count)
}
func (W _github_com_redis_go_redis_v9_VectorSetCmdable) VRem(ctx context.Context, key string, element string) *redis.BoolCmd {
	return W.WVRem(ctx, key, element)
}
func (W _github_com_redis_go_redis_v9_VectorSetCmdable) VSetAttr(ctx context.Context, key string, element string, attr interface{}) *redis.BoolCmd {
	return W.WVSetAttr(ctx, key, element, attr)
}
func (W _github_com_redis_go_redis_v9_VectorSetCmdable) VSim(ctx context.Context, key string, val redis.Vector) *redis.StringSliceCmd {
	return W.WVSim(ctx, key, val)
}
func (W _github_com_redis_go_redis_v9_VectorSetCmdable) VSimWithArgs(ctx context.Context, key string, val redis.Vector, args *redis.VSimArgs) *redis.StringSliceCmd {
	return W.WVSimWithArgs(ctx, key, val, args)
}
func (W _github_com_redis_go_redis_v9_VectorSetCmdable) VSimWithArgsWithScores(ctx context.Context, key string, val redis.Vector, args *redis.VSimArgs) *redis.VectorScoreSliceCmd {
	return W.WVSimWithArgsWithScores(ctx, key, val, args)
}
func (W _github_com_redis_go_redis_v9_VectorSetCmdable) VSimWithScores(ctx context.Context, key string, val redis.Vector) *redis.VectorScoreSliceCmd {
	return W.WVSimWithScores(ctx, key, val)
}
