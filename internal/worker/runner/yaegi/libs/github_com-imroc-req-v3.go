...
func init() {
	Symbols["github.com/imroc/req/v3/req"] = map[string]reflect.Value{
		...
		"SetCommonQueryParamsFromStruct":           reflect.ValueOf(req.SetCommonQueryParamsFromStruct),
		"SetCommonQueryParamsFromValues":           reflect.ValueOf(req.SetCommonQueryParamsFromValues),
		...
		"SetQueryParamsFromStruct":                 reflect.ValueOf(req.SetQueryParamsFromStruct),
		"SetQueryParamsFromValues":                 reflect.ValueOf(req.SetQueryParamsFromValues),
