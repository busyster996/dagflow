...
func init() {
	Symbols["github.com/gin-gonic/gin/gin"] = map[string]reflect.Value{
		...
		"MIMEYAML2":                              reflect.ValueOf(constant.MakeFromLiteral("\"application/yaml\"", token.STRING, 0)),
		...
		"Version":                                reflect.ValueOf(constant.MakeFromLiteral("\"v1.11.0\"", token.STRING, 0)),
		...
		"OnlyFilesFS":        reflect.ValueOf((*gin.OnlyFilesFS)(nil)),
