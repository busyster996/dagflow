// Code generated by 'yaegi extract github.com/busyster996/dagflow/pkg/rabbitmq'. DO NOT EDIT.
...
func init() {
	Symbols["github.com/busyster996/dagflow/pkg/rabbitmq/rabbitmq"] = map[string]reflect.Value{
		...
		"_Logger":   reflect.ValueOf((*_github_com_busyster996_dagflow_pkg_rabbitmq_Logger)(nil)),
		"_Resolver": reflect.ValueOf((*_github_com_busyster996_dagflow_pkg_rabbitmq_Resolver)(nil)),
	}
}

// _github_com_busyster996_dagflow_pkg_rabbitmq_Logger is an interface wrapper for Logger type
type _github_com_busyster996_dagflow_pkg_rabbitmq_Logger struct {
	IValue  interface{}
...
func (W _github_com_busyster996_dagflow_pkg_rabbitmq_Logger) Debugf(format string, args ...any) {
	W.WDebugf(format, args...)
}
func (W _github_com_busyster996_dagflow_pkg_rabbitmq_Logger) Errorf(format string, args ...any) {
	W.WErrorf(format, args...)
}
func (W _github_com_busyster996_dagflow_pkg_rabbitmq_Logger) Infof(format string, args ...any) {
	W.WInfof(format, args...)
}
func (W _github_com_busyster996_dagflow_pkg_rabbitmq_Logger) Warnf(format string, args ...any) {
	W.WWarnf(format, args...)
}

// _github_com_busyster996_dagflow_pkg_rabbitmq_Resolver is an interface wrapper for Resolver type
type _github_com_busyster996_dagflow_pkg_rabbitmq_Resolver struct {
	IValue   interface{}
	WResolve func() ([]string, error)
}

func (W _github_com_busyster996_dagflow_pkg_rabbitmq_Resolver) Resolve() ([]string, error) {
	return W.WResolve()
}
